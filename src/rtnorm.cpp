...
double rtnorm(Rcpp::NumericVector lower, Rcpp::NumericVector upper, double mu, double sigma)
{
  ...
  {
    if (b[0] == R_PosInf)
      r = rtchopin_onesided(a[0]);
    else 
      r = rtchopin_twosided(a[0], b[0]);
  }
